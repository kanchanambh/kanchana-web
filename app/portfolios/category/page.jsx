...
export const metadata = {
  title: "Portfolio Categoty: Graphic Design & Full Stack Development",
  description:
  ...
  alternates: {
    canonical: process.env.BASE_URL + "/portfolios/category",
  },
};
    ...
    <PageWrapper>
      ...
      >
        ...
        <div className="text-white text-3xl">
          <PortfolioByCategory repoPort={repoPort} repoCat={repoCat} />
        </div>
      </div>
    </PageWrapper>
  );
